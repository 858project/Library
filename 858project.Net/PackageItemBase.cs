...
namespace project858.Net
{
    ...
    /// </summary>
    public abstract class PackageItemBase<T> : IPackageItem
    {
        #region - Constructors -
        /// <summary>
        ...
        public PackageItemBase(UInt32 address, T value)
        {
            try
            {
            ...
            {
                throw new Exception(String.Format("Package item 0x{0:X4} failed [Value: {1}].", address, value), ex);
            }
        }
        /// <summary>
        /// Initialize this class
        ...
        /// <param name="address">Item address</param>
        public PackageItemBase(Byte[] data, UInt32 address)
        {
            try
            {
                this.Data = data;
            ...
            {
                throw new Exception(String.Format("Package item 0x{0:X4} failed [Data Length: {1}].", address, data.Length), ex);
            }
        }
        #endregion
        ...
        /// Item type
        /// </summary>
        public abstract PackageItemTypes ItemType { get; }
        /// <summary>
        /// Generics value
        /// </summary>
        ...
        public Byte[] ToByteArray()
        {
            ...
            // add data to result
            Buffer.BlockCopy(data, 0, result, 7, length);
