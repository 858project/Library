...
namespace project858.Net
{
    ...
    /// </summary>
    public sealed class PackageItemDateTime : PackageItemBase<DateTime>
    {
        #region - Constructors -
        /// <summary>
        ...
        public PackageItemDateTime(UInt32 address, DateTime value)
            : base(address, value)
        {
        ...
        /// <param name="address">Item address</param>
        public PackageItemDateTime(Byte[] data, UInt32 address)
            : base(data, address)
        {
        ...
        /// Item type
        /// </summary>
        public override PackageItemTypes ItemType { get { return PackageItemTypes.DateTime; } }
        #endregion
